...
public class VentaServiceImpl implements VentaService {
    ...
    private static final Set<String> CAMPOS_ORDENABLES = Set.of("fecha", "total", "id");
    ...
    public List<VentaResponseDTO> buscar(
        ...
        if (desde != null && hasta != null && desde.isAfter(hasta)) {
            throw new ReglaNegocioException(
                    "El rango de fechas es inválido: 'desde' (" + desde + ") es posterior a 'hasta' (" + hasta + ")");
        }
        ...
        log.info("Fin buscar ventas | clienteId={} | estado={} | desde={} | hasta={} | orden={} {} | filas={} | duracionMs={}",
                clienteId, estado, desde, hasta, ordenarPor, direccion, resultado.size(), System.currentTimeMillis() - inicio);
    ...
    private Sort construirSort(String ordenarPor, String direccion) {
        ...
        if (!CAMPOS_ORDENABLES.contains(campo)) {
            throw new ReglaNegocioException(
                    "El campo de ordenamiento '" + campo + "' no está permitido. Campos válidos: " + CAMPOS_ORDENABLES);
        }
        ...
        if (!sentido.equalsIgnoreCase("asc") && !sentido.equalsIgnoreCase("desc")) {
            throw new ReglaNegocioException(
                    "La dirección de ordenamiento '" + sentido + "' no está permitida. Valores válidos: asc, desc");
        }
